...
public abstract class RadarTypeRepositoryBase extends SimpleDomainRepository<RadarType, RadarTypeEntity, RadarTypeDAO, VersionedIdEntity>
{
    @Autowired
    ...
    public RadarTypeRepositoryBase() {
    ...
    public abstract List<RadarType> findByUser(Long userId);
    public abstract List<RadarType> findByUserAndRadarType(Long userId, String radarTypeId);
    public abstract List<RadarType> findSharedRadarTypesExcludeOwned(Long radarUserId);
