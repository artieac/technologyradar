...
(
    {
        ...
        @org.hibernate.annotations.NamedNativeQuery(name = "findAllTypesByPublishedRadars", query = "SELECT * from RadarTypes rt, TechnologyAssessments ta WHERE rt.Id = ta.RadarTypeId AND rt.Version = ta.RadarTypeVersion AND ta.RadarUserId = :radarUserId and rt.RadarUserId = ta.RadarUserId AND ta.IsPublished = true", resultClass = RadarTypeEntity.class),
