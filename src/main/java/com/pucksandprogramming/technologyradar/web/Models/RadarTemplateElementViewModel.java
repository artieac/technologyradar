...
public class RadarTemplateElementViewModel
{
    private Long id;
    private String name;
    private String displayOption;

    public RadarTemplateElementViewModel()
    {
    }

    public RadarTemplateElementViewModel(RadarRing radarRing)
    {
    ...
    public RadarTemplateElementViewModel(RadarCategory radarCategory)
    {
