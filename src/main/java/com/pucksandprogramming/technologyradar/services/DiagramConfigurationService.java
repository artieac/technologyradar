...
public class DiagramConfigurationService
{
    ...
    public DiagramPresentation generateDiagramData(RadarUser radarUser, Radar radarInstance)
    {
        ...
        retVal.addRadarArcs(radarInstance.getRadarRingSet().getRadarRings());
        ...
        Integer quadrantSize = 360 / radarInstance.getRadarCategorySet().getRadarCategories().size();

        for(RadarCategory radarCategory : radarInstance.getRadarCategorySet().getRadarCategories())
        {
